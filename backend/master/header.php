...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="../../public/dashboard/assets/assets/images/neptune.png" />
            ...
            <div class="logo">
                ...
                <div class="sidebar-user-switcher user-activity-online">
                    <a href="#">
                        ...
                        <img style="width: 50px; height:50px; border-radius:50%;" src="../../public/uploads/default/<?= $user['image'] ?>">
                        <?php else :  ?>
                        <img style="width: 50px; height:50px; border-radius:50%;" src="../../public/uploads/profile/<?= $user['image'] ?>">
                        <?php endif; ?>
